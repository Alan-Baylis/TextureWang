...
//        node.CreateInputOutputs();
        ...
        node.m_Value1 = new FloatRemap(0.5f,-1,1);
        node.m_Value2 = new FloatRemap(0.0f, -1, 1);
        node.m_Value3 = new FloatRemap(0.0f, -1, 1);
        node.m_Value4 = new FloatRemap(0.5f, -1, 1);
        return node;
    }
    ...
    public override void DrawNodePropertyEditor()
    {
        ...
        m_Value3.SliderLabel(this,"dz");//, -10.0f, 10.0f);//,new GUIContent("Red", "Float"), m_R);


        m_Fill = GUILayout.Toggle(m_Fill, "Fill");
//        m_Value5 = (FloatRemap)(m_Fill ? 1 : 0);
...
//        m_Value6 = (FloatRemap)(m_InvertFill ? 1 : 0);
    ...
    {
        _mat.SetVector("_Multiply2", new Vector4(m_Fill ? 1 : 0, m_InvertFill ? 1 : 0,m_OffsetX, m_OffsetY));
