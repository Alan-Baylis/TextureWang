...
public abstract class Texture2MathOp : TextureNode
{
    ...
    public enum MathOp { Add=ShaderOp.Add2, Multiply=ShaderOp.Mult2, Power=ShaderOp.Pow2,Sub=ShaderOp.Sub2, Min = ShaderOp.Min, Max = ShaderOp.Max,Blend =ShaderOp.Blend2, SrcBlend = ShaderOp.SrcBlend }
